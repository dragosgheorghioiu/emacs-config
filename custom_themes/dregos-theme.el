;;; dregos-theme.el --- port of Monokai Octagon -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup dregos-theme nil
  "Options for doom-molokai."
  :group 'doom-themes)

(defcustom dregos-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dregos-theme
  :type 'boolean)

(defcustom dregos-comment-bg dregos-brighter-comments
  "If non-nil, comments will have a subtle, darker background.
Enhancing their legibility."
  :group 'dregos-theme
  :type 'boolean)

(defcustom dregos-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme dregos
  ...
  ((bg         '("#1c1625" nil       nil            ))
   ...
   (selection      base2)
   (builtin        violet)
   (comments       (if dregos-brighter-comments violet base6))
   (doc-comments   (if dregos-brighter-comments (doom-lighten violet 0.1) (doom-lighten base6 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       magenta)
   (methods        green)
   ...
   (-modeline-pad
    (when dregos-padded-modeline
      (if (integerp dregos-padded-modeline) dregos-padded-modeline 4)))
